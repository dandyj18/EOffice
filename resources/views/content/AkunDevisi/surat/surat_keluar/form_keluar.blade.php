...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{route('devisi.KeluarDevisi')}}">Surat Keluar</a></li>
                            ...
                            <div class="form-group col-md-8">
                                ...
                                <div class="mb-3">
                                    <span style="float-right">
                                        ...
                                        <a class="btn btn-success text-white" href="{{route('devisi.KeluarDevisi')}}" role="button">Kembali</a>
                                    </span>
                                </div>
                            </div>
                        </form>
