...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{route('devisi.MasukDevisi')}}">Surat Masuk</a></li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3" style="float:right;">
                                        <span>
                                            ...
                                            <a class="btn btn-success text-white" href="{{route('devisi.MasukDevisi')}}" role="button">Kembali</a>
                                        </span>
                                    </div>
                                </div>
                            </form>
