...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="{{route('insert_level')}}">Insert Level Jabatan</a></li>
        </ol>
    </div>
</div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="basic-form">
                        <form action="{{route('insert_level')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <center>
                                <div class="form-group col-md-8">
                                    <div class="mb-3">
                                        <input type="text" class="form-control input-Default" name="level_jabatan" required="required" placeholder="Level Jabatan">
                                    </div>
                                    <div class="mb-3">
                                        <span>
